...
export function buildWeeklyPlan(weekPlanArray) {
  ...
  // Best day per category (simple: highest confidence day wins per category theme)
  // Without per-day category breakdown from the API, we use confidence + dim heuristics
