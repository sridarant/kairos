 ...
 *
 * P0-02 fix: overallStars now forwarded to adaptRecommendation so the cap
 * (stars ≤ overallStars + 1) is actually applied. Previously the second
 * argument was accepted by BootstrapManager but silently discarded here.
 *
 * @param {object[]} packages     raw recommendation packages from engine
 * @param {number}   overallStars overall day suitability stars (1–5)
 */
