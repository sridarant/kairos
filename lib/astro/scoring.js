...
export const WEIGHTS = {
  base:        0.30,   // time-slot base
  vara:        0.10,   // weekday planet (Vara)
  lunar:       0.05,   // lunar phase
  tithi:       0.05,   // tithi
  nakshatra:   0.10,   // nakshatra
  transit:     0.10,   // planetary transits
  interaction: 0.10,   // Moon+Dasha, Vara+Lagna
  lagna:       0.10,   // birth ascendant
...
export function scoredSlots(astroCtx, userCtx) {
  const { vara, lunar, tithi, nakshatra, transits, lagna, moonSign, interactions } = astroCtx
