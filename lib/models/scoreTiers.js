...
export const SUITABILITY_TIERS = Object.freeze({
  Excellent:   { min:80, stars:5, label:'Excellent day',   shortLabel:'Excellent' },
  Good:        { min:60, stars:4, label:'Good day',         shortLabel:'Good' },
  Neutral:     { min:40, stars:3, label:'Neutral day',      shortLabel:'Neutral' },
  Moderate:    { min:20, stars:2, label:'Moderate day',     shortLabel:'Moderate' },
  Challenging: { min: 0, stars:1, label:'Challenging day',  shortLabel:'Challenging' },
})
