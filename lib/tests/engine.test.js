...

{
  ...
  assert('P0-02 integration: category stars ≤ overall+1',
    maxCatStars <= dec.stars + 1, `catMax=${maxCatStars} overall=${dec.stars}`)
...
// ── Invariant 8: Version consistency ──────────────────────────────────────────
{
  ...
  const vJson = JSON.parse(fs.readFileSync('/home/claude/kairos/public/version.json', 'utf8'))
