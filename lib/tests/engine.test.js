...

{
  ...
  assert('NAV: "Settings" label removed from MobileShell', !mobileSrc.includes("label:'Settings'"))
  assert('NAV: "Profile" label in MobileShell', mobileSrc.includes("label:'Profile'"))
  assert('NAV: "Settings" label removed from DesktopShell', !desktopSrc.includes("label:'Settings'"))
...

{
  ...
  assert('R2.4A SETTINGS: MobileShell renders SettingsScreen for MORE tab',
    mobileSrc2.includes('SettingsScreen') && mobileSrc2.includes('TABS.MORE'))
  assert('R2.4A SETTINGS: MobileShell no longer opens ProfileModal on MORE',
    !mobileSrc2.includes('bs.openProfile()') || !mobileSrc2.includes("TABS.MORE) { bs.openProfile"))

  assert('R2.4A SETTINGS: DesktopShell renders SettingsScreen for MORE tab',
    desktopSrc2.includes('SettingsScreen') && desktopSrc2.includes('TABS.MORE'))
  ...
  assert('R2.4A DESKTOP: panel closed by default',
    desktopSrc2.includes("useState(false)") && desktopSrc2.includes('default closed'))
}
