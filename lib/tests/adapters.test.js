...
assert('stars > 5 → clamped to 1-5 range', rec5.stars <= 5)  // Still clamped to 1-5 max
...
// P0-6: Star capping by overall removed. Domain stars reflect domain-specific evidence.
// rec8.stars may be 5 even on a 2-star day if finance evidence strongly supports it.
assert('stars in valid 1-5 range (no cap by overall)',  rec8.stars >= 1 && rec8.stars <= 5, rec8.stars)
