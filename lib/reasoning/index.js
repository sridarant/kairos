 ...
 */
export function runFullReasoning(astroCtx, goldenSlotScore, goldenWindow, avoidWindow, scoredSlots = []) {
  ...
  const recommendations = buildRecommendations(reasoningResult, goldenWindow, evidenceNodes, scoredSlots)
